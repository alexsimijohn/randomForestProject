...
df["Arrive or Depart Prediction Numerical"] = rfc.predict(X)

df.assign(ArriveOrDepartPrediction=pd.cut(df["Arrive or Depart Prediction Numerical"], bins=[-1, 0, 1],
                                          labels=['Arrival', 'Departure'])).to_csv("prediction.csv",
